...
<template>
    <div class="course-card-list">
        <div class="course-card-container" v-for="course in courses" v-bind:key="course.id">
            <course-card v-bind:course="course"/>
        </div>
    </div>
</template>
